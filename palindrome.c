...
To reverse a given four-digit integer number and check whether it is a palindrome
...
int main()
{
	   ...
	   {
	      digit = n % 10;
	      rev_digits = rev_digits * 10 + digit;   // rev_digits *= 10 + digit; incorrect statment
	      n /= 10;    
	   }
